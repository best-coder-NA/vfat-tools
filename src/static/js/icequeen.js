...
$(function() {
  ...
  async function main() {
    ...
    _print(`Your asset value in pool: $${pool4tvl * userPool4Percent / 100}`)
    ...
    _print(`Your asset value in pool: $${pool3tvl * userPool3Percent / 100}`)
    ...
    _print(`Your asset value in pool: $${pool2tvl * userPool2Percent / 100}`)
    ...
    _print(`Your asset value in pool: $${pool1tvl * userPool1Percent / 100}`)
